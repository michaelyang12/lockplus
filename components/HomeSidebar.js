    ...
    <>
      <div class="relative min-h-screen md:flex">
        <div class="bg-gray-800 text-gray-100 flex justify-between md:flex">
          <div class="sidebar bg-lockplus-blue text-blue-100 w-40 space-y-6 py-7 px-2 absolute inset-y-0 left-0">
            ...
            <a href="#" class="text-white flex items-center space-x-2 px-4 ml-1 hover:text-lockplus-hoverGray">
              ...
              <span class="text-lg font-bold font-lockplus">history</span>
            </a>
            <a href="#" class="text-white flex items-center space-x-2 px-4 ml-1 hover:text-lockplus-hoverGray">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-lg font-bold font-lockplus">settings</span>
            </a>
          </div>
        </div>
      </div>
